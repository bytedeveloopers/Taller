...
const toUICliente = (row: any): Cliente => ({
  ...
  lastVisit: row.updated_at, // por ahora usamos updated_at como "última visita"
  isActive: !!row.is_active,
  createdAt: row.created_at,
  updatedAt: row.updated_at,
  // placeholders hasta enlazar relaciones reales
  vehicles: [],
...
export default function ListadoClientes({
  ...
  const cargarClientes = async (resetPage = false) => {
    try {
      ...
      // IMPORTANTE: sólo enviar parámetros que tu API realmente consume
