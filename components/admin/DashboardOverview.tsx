...
export default function DashboardOverview({ stats }: Props) {
  return (
    <div className="space-y-8">
      {/* Métricas principales según tu estructura */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <SimpleChart
          ...
          type="bar"
          data={[
            { label: "Eficiencia", value: stats?.tasaCompletado || 85, color: "#10b981" },
            { label: "Satisfacción", value: stats?.satisfaccionCliente || 92, color: "#3b82f6" },
            { label: "Capacidad", value: 78, color: "#8b5cf6" },
          ]}
        />
