  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (email === "admin@autorepair.com" && password === "admin123") {
        ...
        // Redireccionar al dashboard (cuando esté implementado)
    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-white">Acceso Administrativo</h2>
        ...
        <div className="mt-8 p-4 bg-gray-800 rounded-lg border border-gray-700">
          <h3 className="text-sm font-medium text-gray-300 mb-2">Credenciales de demo:</h3>
